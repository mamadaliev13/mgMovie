package uz.mamadaliev.mimovie.presentation.actors
...
import uz.mamadaliev.mimovie.databinding.FragmentActorsBinding
import uz.mamadaliev.mimovie.presentation.BaseFragment
import uz.mamadaliev.mimovie.presentation.adapter.ActorCreditInMovieAdapter
import uz.mamadaliev.mimovie.presentation.adapter.ActorCreditInTVShowsAdapter
...
class ActorsFragment : BaseFragment<FragmentActorsBinding>(FragmentActorsBinding::inflate) {
    ...
    override fun onViewCreate() {
        binding.movieCastList.layoutManager = LinearLayoutManager(
            requireContext(),
            LinearLayoutManager.VERTICAL, false
        )
        binding.movieCastList.adapter = adapter

        binding.tvCastList.layoutManager = LinearLayoutManager(
            requireContext(),
            LinearLayoutManager.VERTICAL, false
        )
            ...
            binding.apply {
                ...
                image.setOnClickListener {
                    ...
                    navController.navigate(
                        R.id.action_actorsFragment_to_imageViewerFragment,
                        bundle
                    )
                }
            }
