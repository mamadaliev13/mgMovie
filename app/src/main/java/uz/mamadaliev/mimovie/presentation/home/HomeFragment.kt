package uz.mamadaliev.mimovie.presentation.home
...
import uz.mamadaliev.mimovie.databinding.FragmentHomeBinding
...
class HomeFragment : BaseFragment<FragmentHomeBinding>(FragmentHomeBinding::inflate) {
    ...
    override fun onViewCreate() {
        ...
        binding.apply {
            topRatedMoviesList.layoutManager = LinearLayoutManager(
                requireContext(),
                LinearLayoutManager.HORIZONTAL, false
            )
            topRatedMoviesList.adapter = adapter

            populartMoviesList.layoutManager = LinearLayoutManager(
                requireContext(),
                LinearLayoutManager.HORIZONTAL, false
            )
            populartMoviesList.adapter = adapterPop

            upcomingMoviesList.layoutManager = LinearLayoutManager(
                requireContext(),
                LinearLayoutManager.HORIZONTAL, false
            )
